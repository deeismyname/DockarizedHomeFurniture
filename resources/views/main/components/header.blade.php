                ...
                <div class="row">
                    <div class="col-12 d-flex align-items-center justify-content-between">
                        ...
                        <div class="header-logo">
                            <div class="logo">
                                <a href="index.html"><img src="{{ asset('main/assets/images/logo/logo_white.png') }}"
                                        alt=""></a>
                            </div>
                        </div>
                        <!-- End Header Logo -->
                                            ...
                                            <div class="menu-banner">
                                                <a href="#" class="menu-banner-link">
                                                    <img class="menu-banner-img"
                                                        src="{{ asset('main/assets/images/banner/menu-banner.jpg') }}"
                                                        alt="">
                                                </a>
                                            </div>
                                        </div>
                            ...
                            <body class="antialiased">
                                <div
                                    ...
                                    <div class="hidden fixed top-0 right-0 px-6 py-4 sm:block">
                                        @auth
                                            <a href="{{ route('logout') }}" class="btn btn-outline-light"  style="color: rgb(255, 54, 93)">Log out</a>
                                        @else
                                            <a href="{{ route('login') }}" class="btn btn-outline-success"  style="color: rgb(255, 54, 93)">Log in</a>

                                            @if (Route::has('register'))
                                                <a href="{{ route('register') }}" class="btn btn-outline-primary"  style="color: rgb(255, 54, 93)">Register</a>
                                            @endif
                                        @endauth
                                    </div>
                                @endif
