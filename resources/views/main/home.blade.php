 ...
 <header id = "header" class = "vh-100 carousel slide" data-bs-ride = "carousel" style = "padding-top: 104px;">
    <div class = "container h-100 d-flex align-items-center carousel-inner">
        ...
        <div class = "text-center carousel-item">
            <img src="https://hips.hearstapps.com/hmg-prod.s3.amazonaws.com/images/zara-faux-shearling-chair-1654548559.jpeg?crop=1.00xw:0.668xh;0,0.258xh&resize=480:*" alt="">
    ...
    <button class = "carousel-control-prev" type = "button" style="color: black;" data-bs-target="#header" data-bs-slide = "prev">
        <div class="controls" style="display: block;">
            <div class = "carousel-control-prev-icon" style="background-color: black;"></div>
            <div>previous</div>
        </div>
    </button>
    <button class = "carousel-control-next" type = "button"  style="color: black;" data-bs-target="#header" data-bs-slide = "next">
        <div class="controls" style="display: block;">
